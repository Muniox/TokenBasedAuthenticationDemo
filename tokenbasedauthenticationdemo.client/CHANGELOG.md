...
- Create Angular project with ng: `ng new tokenbasedauthenticationdemo.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`tokenbasedauthenticationdemo.client.esproj`).
